...
private:
    Ort::Env env;
    Ort::Session session_{ env, L"C:/ml/nuget_cmake/build/Debug/mnist.onnx", Ort::SessionOptions{nullptr} };
...
//    std::string modelPath = "C:/ml/nuget_cmake/build/Debug/model.onnx";
